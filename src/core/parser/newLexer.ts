...
const TagWithoutPointer = createToken({
  name: TokenNames.TAG,
  pattern: /[A-Z0-9_]+/,
...
const TagWithPointer = createToken({
  name: TokenNames.TAG,
  pattern: /[A-Z0-9_]+/,
  start_chars_hint: [..."ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_"],
  pop_mode: true,
...
export const GedcomLexer = new Lexer(lexerDefinition);
